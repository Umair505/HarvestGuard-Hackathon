          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-in slide-in-from-left duration-700">
              ...
              <p className="text-lg text-slate-600 max-w-lg">
                বাংলাদেশে প্রতি বছর ৪৫ লক্ষ টন শস্য নষ্ট হয়। গোলাঘর অ্যাপ ব্যবহার করে 
                আবহাওয়ার পূর্বাভাস জানুন এবং বৈজ্ঞানিক উপায়ে শস্য সংরক্ষণ করুন।
              </p>

              {/* বাটন গ্রুপ */}
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 text-lg h-12 px-8">
                  রেজিস্ট্রেশন করুন <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <Button size="lg" variant="outline" className="text-lg h-12 px-8 border-slate-300">
                  কিভাবে কাজ করে?
                </Button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-100">
                <div className="flex items-center gap-2 text-sm font-semibold text-slate-700">
                  <CloudRain className="text-blue-500 w-5 h-5" /> ওয়েদার অ্যালার্ট
                </div>
                <div className="flex items-center gap-2 text-sm font-semibold text-slate-700">
                   <ShieldCheck className="text-emerald-500 w-5 h-5" /> সেইফ স্টোরেজ
                </div>
              </div>
            </div>
            ...
            <div className="relative animate-in slide-in-from-right duration-700 fade-in">
              ...
              >
                      ...
                      <div className="p-1">
                        <Card className="border-0 shadow-xl overflow-hidden rounded-2xl">
                          <CardContent className="flex aspect-[4/3] items-center justify-center p-0 relative group">
                            ...
                            {/* 4. Use Next.js Image Component with 'fill' */}
                            <Image 
                              src={slide.image} 
                              alt={slide.title}
                              fill
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 text-white z-10">
                              <h3 className="text-2xl font-bold font-serif">{slide.title}</h3>
                ...
                {/* নেভিগেশন অ্যারো */}
                <CarouselPrevious className="left-4 bg-white/20 text-white border-0 hover:bg-white hover:text-emerald-700 z-20" />
                <CarouselNext className="right-4 bg-white/20 text-white border-0 hover:bg-white hover:text-emerald-700 z-20" />
              </Carousel>
            </div>
